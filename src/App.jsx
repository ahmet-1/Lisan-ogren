...
function DersEkrani({dilId, hoca, kul, kapat}) {
  ...
  const getPrompt = () => {
    ...
    return okulMantigi + "\n" +
       ...
       "Yazılı/sesli: " +
       (sesliMod
         ? "Öğrenci sesli konuşuyor, kısa net yanıt ver."
         : "Öğrenci yazıyor, yazılı yanıt ver.") +
       "\nŞİMDİ DERSE BAŞLA. Önce " +
       seviye +
       " seviyesine göre bugünkü konuyu tanıt, sonra öğrenciye soru sor.";
};
